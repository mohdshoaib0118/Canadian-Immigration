...
const ActionColumn = (props) => {
    ...
    return (
        <>
            ...
            <div>
                <EditModel rowData={getRowData} parentEditModel={parentEditModel} openModalEditModel={openModalEditModel} childEmptyEditModel={childEmptyEditModel} />
            </div>
        </>
    );
};
                    ...
                    <Col xs={12}>
                        <Card>
                            <Card.Body>
                                ...
                                <Row>
                                    {serviceCategoryDataList?.loading && <Loader />}
                                    ...
                                    <Col>
                                        <Table className="mb-0 mt-3" size="sm">
                                            ...
                                            <tbody>
                                                {serviceCategoryData?.serviceCategoryList?.data?.map((item, index) => {
                                                    return (
                                                        <tr key={index}>
