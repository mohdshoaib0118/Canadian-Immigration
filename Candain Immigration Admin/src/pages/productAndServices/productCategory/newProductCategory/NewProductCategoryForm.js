                            ...
                            <Col lg={12}>
                                    ...
                                    <Col lg={6}>
                                        <Form.Group controlId="validationCustom01">
                                            <Row className='d-flex align-items-center'>
                                                ...
                                                <Col lg={9}>
                                                    <Form.Control required type="text" placeholder="" value='17' disabled />
                                    ...
                                    <Col lg={6}>
                                        <Form.Group controlId="validationCustom01">
                                            <Row className='d-flex align-items-center'>
                                                ...
                                                <Col lg={9}>
                                                    <Form.Control required type="text" placeholder="MAN, WOMEN, KIDS, HOUSEHOLD etc" />
                                                    <Form.Control.Feedback>Looks good!</Form.Control.Feedback>
                                                </Col>
                                            </Row>
                                        </Form.Group>
                                ...
                                <Row className='my-4' >
                                    ...
                                    <Col lg={6}>
                                        <Form.Group controlId="validationCustom01">
                                            <Row className='d-flex align-items-center'>
                                                <Col lg={3}><Form.Label>Description :<span className='text-danger'>*</span>:</Form.Label></Col>
                                                <Col lg={9}>
