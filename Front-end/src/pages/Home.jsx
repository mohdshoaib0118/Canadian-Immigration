    ...
    return (
        <div>
            ...
            <div className='grid lg:grid-cols-3 xl:gap-20 lg:gap-8 md:gap-12 gap-6 lg:py-8 lg:px-8 md:px-32 xl:px-19 mb-10 py-12 container mx-auto  px-5'>
                <div className='bg-[#F4FBFF] lg:py-12 xl:px-14 px-7 md:py-14 py-7 rounded-2xl relative'>
                    ...
                    <h6 className='text-[#006AAB] text-md absolute bottom-1.5 flex items-center gap-1'>Read More <GoArrowUpRight /></h6>
                </div>
                <div className='bg-[#F4FBFF] md:py-12 py-7 xl:px-14 px-7 rounded-2xl relative'>
            ...
            <div className='grid lg:grid-cols-3 gap-6 lg:px-8 xl:px-20 md:px-32 pt-4 xl:pb-20 pb-18   lg:py-8 container mx-auto px-5'>
                <div className='border-1 border-[#006AAB] rounded-2xl  lg:p-8  lg:py-12 p-6 bg-[#F4FBFF] relative hover:bg-[#006AAB] hover:text-white group transition duration-400 cursor-pointer'>
            ...
            <div className='bg-[#006AAB]'>
                <div className='grid lg:grid-cols-2 px-5 lg:px-8 xl:px-20 md:px-32 xl:py-16 py-12 gap-16 container mx-auto'>
                    <div className='bg-white lg:px-12 py-10 px-5  relative pb-28
                '>
                    ...
                    <div className='bg-white lg:px-12 py-10 relative px-5  pb-28'>
                        <h1 className="lg:text-5xl md:text-4xl text-3xl  font-bold leading-tight lg:mb-5 md:mb-3 mb-2">
